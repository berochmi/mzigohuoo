<ul class="navbar-nav">
    <li class="nav-item m-1">
        <a class="nav-link btn btn-danger rounded-0 text-white" href="<?= PROOT; ?>SalesCounter">Dashboard</a>
    </li>
    <li class="nav-item m-1 dropdown">
        ...
        <div class="dropdown-menu rounded-0">
            ...
            <a class="dropdown-item" href="<?= PROOT; ?>SalesCounter/allSentPackages">All Packages</a>
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="<?= PROOT; ?>users/add">Add User</a>
        </div>
    </li>
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown"
