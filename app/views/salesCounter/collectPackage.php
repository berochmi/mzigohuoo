    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-4 mt-4">
                <h3 class="text-primary">Package Collection</h3>
            </div>
        ...
        <form class="mb-1" name="add_site" id="add_site" method="POST" action="<?= $action; ?>">
            <div class="row form-group">
                <div class="col-sm-2">
                    ...
                    <input type="text" name="receipt_no" id="receipt_no"
                        class="form-control mb-2 mr-sm-2 font-weight-bold border-0" value="<?= $receipt_no; ?>" required
                        readonly style="background-color: white;" />
                </div>
                <div class="col-sm-2">
                    <label class="" for="sending_package_status">Status</label>
                    <input type="text" name="sending_package_status" id="sending_package_status"
                        class="form-control mb-2 mr-sm-2 font-weight-bold border-0"
                        value="<?= $sending_package_status; ?>" required readonly style="background-color: white;" />
                </div>
            </div>
            <hr class="bg-info" />
            <div class="row form-group">
            ...
            <div class="row form-group">
                <div class="col-sm-1 ml-auto">
                    <label class="" for="received_date">Date Arrived</label>
                    <input type="text" name="received_date" id="received_date" data-provide="datepicker"
                        data-date-format="yyyy-mm-dd" class="form-control mb-2 mr-sm-2" readonly
                        value="<?= $received_date; ?>" required style="background-color:white;" />
                </div>
                <div class="col-sm-1 text-center">
                    <label class="" for="received_time">Time Arrived</label>
                    <input type="text" name="received_time" id="received_time"
                        class="form-control mb-2 mr-sm-2 timepicker-without-dropdown" style="background: white;"
                        value="<?= $received_time;?>" required placeholder="hh:mm" />
                </div>
                <div class="col-sm-6">
                    <label class="" for="received_package_description">Arrived Package Description</label>
                    <input type="text" name="received_package_description" id="received_package_description"
                        class="form-control mb-2 mr-sm-2" value="<?= $received_package_description; ?>" required />
                </div>
                <div class="col-sm-1 text-center">
                    <label for="received_package_qty">Arrived Qty</label>
                    <input type="text" name="received_package_qty" id="received_package_qty"
                        class="form-control mb-2 mr-sm-2 text-right" value="<?= $received_package_qty; ?>" required />
                </div>
                <div class="col-sm-1">
                    <label class="" for="received_collection_date">Collect Date 2</label>
                    <input type="text" name="received_collection_date" id="received_collection_date"
                        data-provide="datepicker" data-date-format="yyyy-mm-dd" class="form-control mb-2 mr-sm-2"
                        readonly value="<?= $received_collection_date; ?>" required style="background-color:white;" />
                </div>
                <div class="col-sm-1 text-center">
                    <label class="" for="received_collection_time">Collect Time 2</label>
                    <input type="text" name="received_collection_time" id="received_collection_time"
                        class="form-control mb-2 mr-sm-2 timepicker-without-dropdown" style="background: white;"
                        value="<?= $received_collection_time;?>" required placeholder="hh:mm" />
                </div>
            ...
            <div class="row form-group">
                <div class="col-sm-1">
                    <label class="" for="collected_date">Date Collected</label>
                    <input type="text" name="collected_date" id="collected_date" data-provide="datepicker"
                        data-date-format="yyyy-mm-dd" class="form-control mb-2 mr-sm-2" readonly
                        value="<?= $collected_date; ?>" required style="background-color:white;" />
                </div>
                <div class="col-sm-1 text-center">
                    <label class="" for="collected_time">Time Collected</label>
                    <input type="text" name="collected_time" id="collected_time"
                        class="form-control mb-2 mr-sm-2 timepicker-without-dropdown" style="background: white;"
                        value="<?= $collected_time;?>" required placeholder="hh:mm" />
                </div>
                <div class="col-sm-3">
                    <label class="" for="collected_by_name">Collected By</label>
                    <input type="text" name="collected_by_name" id="collected_by_name" class="form-control mb-2 mr-sm-2"
                        value="<?= $collected_by_name; ?>" required />
                </div>
                <div class="col-sm-3">
                    <label class="" for="collected_by_contacts">Contacts</label>
                    <input type="text" name="collected_by_contacts" id="collected_by_contacts"
                        class="form-control mb-2 mr-sm-2 my-num-only" value="<?= $collected_by_contacts; ?>" required />
                </div>
                <div class="col-sm-2">
                    <label class="" for="collected_by_idno">ID No</label>
                    <input type="text" name="collected_by_idno" id="collected_by_idno" class="form-control mb-2 mr-sm-2"
                        value="<?= $collected_by_idno; ?>" required />
                </div>
                <div class="col-sm-2">
                    <label class="" for="collected_by_id_type">ID Type</label>
                    <select class="form-control lazima" name="collected_by_id_type" id="collected_by_id_type">
                        <option></option>
                        <option <?= $collected_by_id_type == "NATIONAL ID"?" selected ":"";?>>NATIONAL ID</option>
                        <option <?= $collected_by_id_type == "DRIVERS LICENSE"?" selected ":"";?>>DRIVERS LICENSE
                        </option>
                        <option <?= $collected_by_id_type == "PASSPORT"?" selected ":"";?>>PASSPORT</option>
                        <option <?= $collected_by_id_type == "VOTERS CARD"?" selected ":"";?>>VOTERS CARD</option>
                        <option <?= $collected_by_id_type == "OTHER"?" selected ":"";?>>OTHER</option>
            ...
            <div class="row form-group">
                <div class="col-sm-1 ml-auto">
                    <label class="" for="collect_package" style="color:white;">Collect</label>
                    <button type="submit" name="collect_package" id="collect_package"
                        class="form-control btn btn-success mb-2 rounded-0">Collect</button>
                </div>
                <div class="col-sm-1">
                    <label class="" for="send_sms" style="color:white;">send_sms</label>
                    <button type="submit" name="send_sms" id="send_sms"
                        class="form-control btn btn-warning mb-2 rounded-0"
                        <?= $sending_package_status=="COLLECTED"?" ":" disabled ";?>>SMS</button>
                </div>
            </div>
            <h3>QR Code</h3>
            <div class="row form-group">
...
<script src="<?= PROOT; ?>js/salesCounter/collectPackage.js?v=3"></script>
<?php $this->end(); ?>