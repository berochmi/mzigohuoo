    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-4 mt-4">
                <h3 class="text-primary">Receive Package</h3>
            </div>
        ...
        <form class="mb-1" name="add_site" id="add_site" method="POST" action="<?= $action; ?>">
            ...
            <div class="row form-group">
                <div class="col-sm-1 ml-auto">
                    <label class="" for="receive_package" style="color:white;">Receive</label>
                    <button type="submit" name="receive_package" id="receive_package"
                        class="form-control btn btn-success mb-2 rounded-0">Receive</button>
                </div>
                <div class="col-sm-1">
                    ...
                    <button type="submit" name="send_sms" id="send_sms"
                        ...
                        <?= $sending_package_status=="ARRIVED"?" ":" disabled ";?>>SMS</button>
                </div>
            </div>
            <h3>QR Code</h3>
            <div class="row form-group">
...
<script src="<?= PROOT; ?>js/salesCounter/receivePackage.js?v=2"></script>
<?php $this->end(); ?>